...
const projects = [
    {
      name: 'Mood-Based UI',
      description: 'A dynamic website that changes its UI based on user mood, determined by analyzing mouse usage patterns.',
      image: dynamic_ui_img, // Replace with actual image paths
    ...
    {
      name: 'M33t',
      description: 'A social platform designed to connect people with similar interests and facilitate event planning.',
      image: m33t_img,
    ...
    },
    {
      ...
      description: 'A comprehensive order system for renting various types of lifts, including scissor lifts, boom lifts, and forklifts.',
    ...
    },
    {
      ...
      description: 'A cyber playground for capture the flag challenges, designed to improve cybersecurity skills.',
      image: ctf_zone_img,
    ...
    
    {
      ...
      description: 'A fitness hub website for TheBoxTivon, providing information about classes, trainers, and booking options.',
